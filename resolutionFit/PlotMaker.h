// $Id: PlotMaker.h,v 1.29 2012/06/15 23:05:55 mschrode Exp $
...
namespace resolutionFit {
  ...
  private:
    ...
    TString histFileName(const TString &id, const EtaBin* etaBin, SampleLabel sampleLabel, unsigned int ptSoftBin) const;
