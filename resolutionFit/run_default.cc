// $Id: run.cc,v 1.64 2012/03/07 13:51:05 mschrode Exp $
...
int main(int argc, char *argv[]) {
  ...
  Parameters* par = new Parameters("PileUpStudy_163337-180252","config/Analysis2011/Binning/BinningAdmin2011_v2.cfg",0);
...
//   TString pathToFitResultsMC = pathToHome+"results/ResolutionFit/QCD_Pt-15to3000_TuneZ2_Flat_7TeV-pythia6_Summer11-PU_S3_START42_V11-v2";
  ...
  TString pathToFitResultsData = pathToHome+"~/scratch/tmp/";
  TString pathToFitResultsMC = pathToHome+"~/scratch/tmp/";
