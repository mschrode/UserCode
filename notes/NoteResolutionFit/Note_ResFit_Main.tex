% $Id: Note_ResFit_Main.tex,v 1.1 2010/05/30 19:43:08 mschrode Exp $
...
\include{Note_ResFit_ToyMC}
\include{Note_ResFit_QCDMC}
\include{Note_ResFit_QCDMC_Extrapolation}
\include{Note_ResFit_Todo}
...
\begin{figure}[ht]
  ...
  \end{center}
  \caption{(a) \ptpart distribution and (b) MC truth resolution of the leading two jets in the selected dijet sample.
...
In Fig.~\ref{fig:resFit:qcd:mhtGauss} the \mht spectrum resulting from the weighted \ptpart of the two jets is compared to the \mht spectrum from the corresponding \ptreco.
