% $Id: Note_ResFit_Introduction.tex,v 1.12 2010/09/27 16:43:44 mschrode Exp $
...
It is foreseen to predict this contribution by smearing QCD seed events with the full jet \pt response function \fixme{cite: RA2 note}.
...
The unbinned method has certain advantages in comparison to a more robust binned fit of the histograms of the asymmetry distributions \fixme{cite:Hauke}.
...
The general method, including the defintion of the dijet likelihood, is described in \qsec{sec:ResFit:Method}.
